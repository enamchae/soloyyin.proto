...
const createStreamedClone = media => {
	const mediaClone = document.createElement("audio");
	mediaClone.srcObject = media.captureStream();
	return mediaClone;
};
...
export class TailSolo {
	...
	constructor(media, {
		...
		// this.streamedClone = createStreamedClone(media);

		// maxamp not calculated correctly yet
		this.extremaAnalyser = new ExtremaAnalyser(media/* this.streamedClone */, {
